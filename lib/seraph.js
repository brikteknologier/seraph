...
// Add index functions 
seraph.index = bindToRoot( require('./index') );

// Alias & curry seraph.index on seraph.node & seraph.rel
seraph.node.index = naan.crock(seraph.index, naan.ncurry, 'node', 1);
seraph.rel.index = naan.crock(seraph.index, naan.ncurry, 'relationship', 1);
