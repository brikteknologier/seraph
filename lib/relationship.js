...
module.exports = {
  ...
  create: function(options, startNode, type, endNode, properties, callback) {
    ...
    if (Array.isArray(startNode)) {
      ...
      return this._throttleMap(startNode, createRel, callback);
      ...
      return this._throttleMap(endNode, createRel, callback);
    }
  ...
  update: function(options, rel, callback) {
    if (Array.isArray(rel)) {
      ...
      return this._throttleMap(rel, updateRel, callback);
    }
  ...
  read: function(options, id, callback) {
    if (Array.isArray(id)) {
      ...
      return this._throttleMap(id, boundReadRelationship, callback);
    }
